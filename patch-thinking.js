...
// Display help
if (showHelp) {
  console.log('Claude Code Thinking Visibility Patcher v2.0.57');
  console.log('==============================================\n');
...
// Patch 1: HM2 Banner Removal (v2.0.57)
// Note: Changed from CL2 (v2.0.56) to HM2 (v2.0.57), oOA/EP namespaces
const bannerSearchPattern = 'function HM2({streamMode:A}){let[Q,B]=oOA.useState(null),[G,Z]=oOA.useState(null);if(oOA.useEffect(()=>{if(A==="thinking"&&Q===null)B(Date.now());else if(A!=="thinking"&&Q!==null)Z(Date.now()-Q),B(null)},[A,Q]),A==="thinking")return EP.createElement(j,{marginTop:1},EP.createElement($,{dimColor:!0},"∴ Thinking…"));if(G!==null)return EP.createElement(j,{marginTop:1},EP.createElement($,{dimColor:!0},"∴ Thought for ",Math.max(1,Math.round(G/1000)),"s (",EP.createElement($,{dimColor:!0,bold:!0},"ctrl+o")," ","to show thinking)"));return null}';
const bannerReplacement = 'function HM2({streamMode:A}){return null}';

// Patch 2: Thinking Visibility (v2.0.57)
// Note: Changed from b29/v3 (v2.0.56) to K49/b3 (v2.0.57)
const thinkingSearchPattern = 'case"thinking":if(!K&&!G)return null;return b3.createElement(K49,{addMargin:Q,param:A,isTranscriptMode:K,verbose:G});';
const thinkingReplacement = 'case"thinking":return b3.createElement(K49,{addMargin:Q,param:A,isTranscriptMode:!0,verbose:G});';
...
console.log('Patch 1: HM2 banner removal');
...
if (patch1Applied) {
  ...
  console.log('✅ Patch 1 applied: HM2 function now returns null');
}
