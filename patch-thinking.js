...
// Display help
if (showHelp) {
  console.log('Claude Code Thinking Visibility Patcher v2.0.53');
  console.log('==============================================\n');
...
// Patch 1: hq2 Banner Removal (v2.0.53)
// Note: Changed from Et2 (v2.0.46) to hq2 (v2.0.53), dMA/QP namespaces
const bannerSearchPattern = 'function hq2({streamMode:A}){let[Q,B]=dMA.useState(null),[G,Z]=dMA.useState(null);if(dMA.useEffect(()=>{if(A==="thinking"&&Q===null)B(Date.now());else if(A!=="thinking"&&Q!==null)Z(Date.now()-Q),B(null)},[A,Q]),A==="thinking")return QP.createElement(j,{marginTop:1},QP.createElement($,{dimColor:!0},"∴ Thinking…"));if(G!==null)return QP.createElement(j,{marginTop:1},QP.createElement($,{dimColor:!0},"∴ Thought for ",Math.max(1,Math.round(G/1000)),"s (",QP.createElement($,{dimColor:!0,bold:!0},"ctrl+o")," ","to show thinking)"));return null}';
const bannerReplacement = 'function hq2({streamMode:A}){return null}';

// Patch 2: Thinking Visibility (v2.0.53)
// Note: Changed from T32/H7 (v2.0.46) to o09/L3 (v2.0.53)
const thinkingSearchPattern = 'case"thinking":if(!K&&!G)return null;return L3.createElement(o09,{addMargin:Q,param:A,isTranscriptMode:K,verbose:G});';
const thinkingReplacement = 'case"thinking":return L3.createElement(o09,{addMargin:Q,param:A,isTranscriptMode:!0,verbose:G});';
...
console.log('Patch 1: hq2 banner removal');
...
if (patch1Applied) {
  ...
  console.log('✅ Patch 1 applied: hq2 function now returns null');
}
